/*
 * journal. — un journal quotidien personnel qui s'exécute sur votre appareil.
 * Copyright (C) 2026  les auteurs de journal.
 *
 ...
 *
 * Contact : contact@journal.app — code source : https://github.com/trced/journal
 *
